...
class REQ02ConsultarLivroAPITests {
	...
	void ct01_quando_cosulta_todos_retorna2() {
		...
		ResponseEntity<List<Livro>> resposta = testRestTemplate.exchange(urlBase, HttpMethod.GET, null,
				tipoRetorno);
...
//			Long id = re.getId();
//			ResponseEntity<Livro> resposta = testRestTemplate.getForEntity(urlBase + "/"+id, Livro.class);
