...
import com.fatec.scel.mantemLivro.adapters.APILivroController;
...
class REQ01CadastrarLivroAPITests {
	...
	public void ct02_quando_metodo_http_nao_disponivel_retorna_http_405() throws Exception{
		...
		ResponseEntity<String> resposta2 = testRestTemplate.exchange(urlBase, HttpMethod.PUT, httpEntity3, String.class);
